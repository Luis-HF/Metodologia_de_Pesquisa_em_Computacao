...
```bash
.
├── src/        # Códigos-fonte utilizados no artigo
├── data/       # Conjuntos de dados utilizados nos experimentos
├── scripts/    # Scripts auxiliares de automação e análise
├── paper/      # Artigo científico e versões em PDF
└── README.md